...
INSERT INTO `chat` VALUES (1,2,1,'test1','2024-04-07 17:49:12',1),(2,2,1,'test2','2024-04-07 17:49:20',1),(3,1,2,'Hello','2024-04-08 17:45:37',1),(4,1,2,'我在马路边，捡到一分钱','2024-04-08 20:19:42',0),(5,1,2,'我把它交到警察叔叔手里边','2024-04-08 20:23:31',0),(6,1,2,'后面不会唱了','2024-04-08 20:25:55',0),(7,1,2,'真的不会了','2024-04-08 20:27:30',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='圈子(但是我觉得叫group更合适)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `group` VALUES (1,'大学生摸鱼组',1,'2024-04-05 23:06:20','一时摸鱼一时爽，一直摸鱼一直爽！');
...
INSERT INTO `group_discussion` VALUES (1,1,1,'2024-04-06 17:32:38','今天晚饭吃什么？','吃外卖吃腻了，学校食堂也不好吃，还有什么能选的吗QAQ',1);
...
CREATE TABLE `group_discussion_reply` (
  ...
  CONSTRAINT `discuss_reply_discuss_id_fk` FOREIGN KEY (`discussion_id`) REFERENCES `group_discussion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `discuss_reply_user_id_fk` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `group_discussion_reply` VALUES (1,1,'2024-04-06 22:06:25','去小吃街呗，挺不错的',1);
...
INSERT INTO `group_user` VALUES (1,1,'2024-04-05 23:06:20');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='书评';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `journal` VALUES (1,'测试_标题','测试_正文_行1','测试_正文_行1\n测试_正文_行2','2024-04-02 14:22:14',1,2),(4,'test2','test123','test123\ntest321\n\n葬送的芙莉莲实在是太好看力','2024-04-04 14:57:40',1,3),(8,'test233333312415125','说的道理123455145','说的道理123455145','2024-04-08 23:13:51',1,1);
...
INSERT INTO `journal_comment` VALUES (5,'2024-04-02 14:22:31',1,1,'测试评论',1),(6,'2024-04-02 20:28:01',2,1,'测试评论2',1),(11,'2024-04-07 18:32:28',1,1,'测试评论3',1);
...
INSERT INTO `journal_like` VALUES (1,1,'2024-04-04 13:54:22'),(1,4,'2024-04-04 14:57:46');
...
INSERT INTO `user` VALUES (1,'MoYun_Admin','scrypt:32768:8:1$JNxRgYZe7QNuoXvn$908d80d5138f79ad57a4ea787e8c9fcd3c96cabcb860e0e64fc260fdfd7087dc8fc44523a3cb4108fb117dbb0d78082c65c3403e9cfcd0be8fbb943d7f8bbd76','道阻且长','Steven-Zhl@foxmail.com','15264051001','admin'),(2,'Test','scrypt:32768:8:1$JNxRgYZe7QNuoXvn$908d80d5138f79ad57a4ea787e8c9fcd3c96cabcb860e0e64fc260fdfd7087dc8fc44523a3cb4108fb117dbb0d78082c65c3403e9cfcd0be8fbb943d7f8bbd76','',NULL,NULL,'student');
...
-- Dump completed on 2024-04-08 23:20:13

ALTER TABLE `book` DROP COLUMN `douban_score`;
ALTER TABLE `book` DROP COLUMN `douban_id`;
ALTER TABLE `book` DROP COLUMN `bangumi_score`;
ALTER TABLE `book` DROP COLUMN `bangumi_id`;
